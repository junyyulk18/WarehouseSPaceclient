...
(1000 đ/phút)
<br></br>
Gửi yêu cầu hỗ trợ: warehousespace2022@gmail.com
<br></br>
                ...
                />
                    ...
                    <div className="col-md-4 col-lg-3 mx-auto my-md-4 my-0 mt-4 mb-1">
                        ...
                        <ul className="list-unstyled">
                            <li>
                                <p><br></br>
                                    <i className="fa fa-home mr-2" />280 An Dương Vương - Tp HCM</p>
                            </li>
                            <li>
                                <p>
                                    <i className="fa fa-envelope mr-2" />warehousespace2022@gmail.com</p>
                            </li>
                            <li>
                                <p>
                                    <i className="fa fa-phone mr-2" />0779951537</p>
                                <p>
                    ...
                    <h7 className="font-weight-bold text-uppercase mb-4">Kết nối với chúng tôi</h7><br></br>
                        <a href='https://www.facebook.com/profile.php?id=100088395049096' type="button" className="btn-floating btn-fb">
...
Bạn muốn săn giá sốc, WareHouse có giá sốc mỗi ngày cho bạn! Bạn là tín đồ của các thương hiệu, các cửa hàng Official chính hãng đang chờ đón bạn. Không cần săn mã freeship, vì WareHouse đã có hàng triệu Voucher đang chờ đợi bạn. Bên cạnh đó hãy mua sắm tại WareHouse để đảm bảo sức khỏe, tiết kiệm thời gian vàng bạc của bạn trong thời kỳ dịch bệnh Covid này.
            ...
            <div className="footer-copyright text-center py-3">Copyright © 2022 WareHouse Space
            </div>
        </footer>
    );
}
